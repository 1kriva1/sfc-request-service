...
using SFC.Request.Infrastructure.Interceptors.Grpc.Client;
using SFC.Request.Infrastructure.Interceptors.Grpc.Server;
using SFC.Request.Infrastructure.Services.Identity;
using SFC.Request.Infrastructure.Settings.Grpc;
...
namespace SFC.Request.Infrastructure.Extensions.Grpc;
