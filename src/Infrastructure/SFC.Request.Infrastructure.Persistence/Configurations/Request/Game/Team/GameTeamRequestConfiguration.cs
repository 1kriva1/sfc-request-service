...
namespace SFC.Request.Infrastructure.Persistence.Configurations.Request.Game.Team;
public class GameTeamRequestConfiguration : AuditableEntityConfiguration<GameTeamRequest, long>
{
    public override void Configure(EntityTypeBuilder<GameTeamRequest> builder)
    {
        ...
        builder.ToTable("GameTeamRequests");
