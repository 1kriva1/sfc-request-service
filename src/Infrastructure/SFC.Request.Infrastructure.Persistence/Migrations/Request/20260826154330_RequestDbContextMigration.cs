...
{
    /// <inheritdoc />
    public partial class RequestDbContextMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameId = table.Column<long>(type: "bigint", nullable: false),
                    GameComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: true),
                    PlayerId = table.Column<long>(type: "bigint", nullable: false),
                    PlayerComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlayerRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GamePlayerRequests_Games_GameId",
                        column: x => x.GameId,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerRequests_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalSchema: "Player",
                        principalTable: "Players",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerRequests_RequestStatuses_StatusId",
                        column: x => x.StatusId,
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePlayerRequests_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerRequests_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerRequests_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTeamRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameTeamRequests_Games_GameId",
                        column: x => x.GameId,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamRequests_RequestStatuses_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Request",
                        principalTable: "RequestStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameTeamRequests_Teams_TeamId",
                        column: x => x.TeamId,
                        principalSchema: "Team",
                        principalTable: "Teams",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamRequests_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamRequests_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamRequests_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPlayerRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamPlayerRequests_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalSchema: "Player",
                        principalTable: "Players",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerRequests_RequestStatuses_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Request",
                        principalTable: "RequestStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPlayerRequests_Teams_TeamId",
                        column: x => x.TeamId,
                        principalSchema: "Team",
                        principalTable: "Teams",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerRequests_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerRequests_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerRequests_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2026, 8, 26, 15, 43, 29, 944, DateTimeKind.Utc).AddTicks(3463), "Actual" },
                    { 1, new DateTime(2026, 8, 26, 15, 43, 29, 944, DateTimeKind.Utc).AddTicks(3475), "Accepted" },
                    { 2, new DateTime(2026, 8, 26, 15, 43, 29, 944, DateTimeKind.Utc).AddTicks(3479), "Declined" },
                    { 3, new DateTime(2026, 8, 26, 15, 43, 29, 944, DateTimeKind.Utc).AddTicks(3484), "Canceled" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerRequests_CreatedBy",
                schema: "Request",
                table: "GamePlayerRequests",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerRequests_GameId",
                schema: "Request",
                table: "GamePlayerRequests",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerRequests_LastModifiedBy",
                schema: "Request",
                table: "GamePlayerRequests",
                column: "LastModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerRequests_PlayerId",
                schema: "Request",
                table: "GamePlayerRequests",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerRequests_StatusId",
                schema: "Request",
                table: "GamePlayerRequests",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerRequests_UserId",
                schema: "Request",
                table: "GamePlayerRequests",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameTeamRequests_CreatedBy",
                schema: "Request",
                table: "GameTeamRequests",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamRequests_GameId",
                schema: "Request",
                table: "GameTeamRequests",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamRequests_LastModifiedBy",
                schema: "Request",
                table: "GameTeamRequests",
                column: "LastModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamRequests_StatusId",
                schema: "Request",
                table: "GameTeamRequests",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamRequests_TeamId",
                schema: "Request",
                table: "GameTeamRequests",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamRequests_UserId",
                schema: "Request",
                table: "GameTeamRequests",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerRequests_CreatedBy",
                schema: "Request",
                table: "TeamPlayerRequests",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerRequests_LastModifiedBy",
                schema: "Request",
                table: "TeamPlayerRequests",
                column: "LastModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerRequests_PlayerId",
                schema: "Request",
                table: "TeamPlayerRequests",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerRequests_StatusId",
                schema: "Request",
                table: "TeamPlayerRequests",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerRequests_TeamId",
                schema: "Request",
                table: "TeamPlayerRequests",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerRequests_UserId",
                schema: "Request",
                table: "TeamPlayerRequests",
                column: "UserId");
