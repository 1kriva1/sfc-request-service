...
public class CreateGameTeamRequestViewModel : IMapFrom<GameTeamRequest>
{
    public required GameTeamRequestDto Request { get; set; }

    public void Mapping(Profile profile) => profile.CreateMap<GameTeamRequest, CreateGameTeamRequestViewModel>()
