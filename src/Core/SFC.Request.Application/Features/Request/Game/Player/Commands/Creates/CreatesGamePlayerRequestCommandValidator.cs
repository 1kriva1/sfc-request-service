...
public class CreatesGamePlayerRequestCommandValidator : AbstractValidator<CreatesGamePlayerRequestCommand>
{
    ...
    public CreatesGamePlayerRequestCommandValidator(
        ...
        IGamePlayerRepository gamePlayerRepository)
    {
        ...
        RuleForEach(p => p.Requests)
           .SetValidator(new GamePlayerRequestValidator(
               _gameRepository, _playerRepository,
               _gamePlayerRequestRepository, _gamePlayerRepository));
    }
}

public class GamePlayerRequestValidator : AbstractValidator<CreatesGamePlayerRequestDto>
{
    private readonly IGameRepository _gameRepository;
    private readonly IPlayerRepository _playerRepository;
    private readonly IGamePlayerRequestRepository _gamePlayerRequestRepository;
    ...
    public GamePlayerRequestValidator(
        IGameRepository gameRepository,
        IPlayerRepository playerRepository,
        IGamePlayerRequestRepository gamePlayerRequestRepository,
        IGamePlayerRepository gamePlayerRepository)
    ...
    private void SetRulesForRequest()
    {
        ...
        RuleFor(Request => Request)
            ...
            .WithMessage(Localization.GamePlayerRequestActiveAlreadyExist);
    }
}