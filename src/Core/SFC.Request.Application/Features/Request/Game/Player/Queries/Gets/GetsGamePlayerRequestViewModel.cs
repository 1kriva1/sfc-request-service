...
public class GetsGamePlayerRequestViewModel : IMapFrom<IEnumerable<GamePlayerRequest>>
{
    public required IEnumerable<GamePlayerRequestDto> Requests { get; set; }

    public void Mapping(Profile profile) => profile.CreateMap<IEnumerable<GamePlayerRequest>, GetsGamePlayerRequestViewModel>()
